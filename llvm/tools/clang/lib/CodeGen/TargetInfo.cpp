...
public:
  RL78TargetCodeGenInfo(CodeGen::CodeGenTypes &CGT)
      : TargetCodeGenInfo(new RL78ABIInfo(CGT)) {}
  ...
  void setTargetAttributes(const Decl *D, llvm::GlobalValue *GV,
    ...
    if (const auto *FD = dyn_cast_or_null<FunctionDecl>(D)) {
      ...
      if (CGM.getLangOpts().RenesasExt &&
        ...
        std::string section =
            Fn->getFnAttribute("implicit-section-name").getValueAsString();
    ...
    if (const auto *VD = dyn_cast_or_null<VarDecl>(D)) {
      ...
      if (CGM.getLangOpts().RenesasExt && AS.hasAttribute("bss-section") &&
        ...
        std::string section = AS.getAttribute("bss-section").getValueAsString();
      ...
      if (CGM.getLangOpts().RenesasExt && AS.hasAttribute("data-section") &&
        ...
        std::string section =
            AS.getAttribute("data-section").getValueAsString();
        section = replaceSectionNamePlaceholder(section, prefix);
      ...
      if (CGM.getLangOpts().RenesasExt && AS.hasAttribute("rodata-section") &&
        ...
        std::string section =
            AS.getAttribute("rodata-section").getValueAsString();
        section = replaceSectionNamePlaceholder(section, prefix);
